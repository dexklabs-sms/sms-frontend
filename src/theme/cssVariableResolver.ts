...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
  variables: {
    // variables that do not depend on a color scheme
  ...
  light: {
    // all variables that depend on a light color scheme
    "--mantine-primary-color-contrast": "var(--mantine-color-zinc-0)", // used as the primary color contrast
    ...
    "--mantine-color-error": "var(--mantine-color-error-10)", // used as an error color
    "--mantine-color-placeholder": "var(--mantine-color-secondary-10)", // used as a placeholder color
    "--mantine-color-anchor": "var(--mantine-color-secondary-10)", // used as anchor color

    "--mantine-color-default": "var(--mantine-color-secondary-0)", // used as the default surface color
    "--mantine-color-default-hover": "var(--mantine-color-secondary-1)", // used as the default hover color
